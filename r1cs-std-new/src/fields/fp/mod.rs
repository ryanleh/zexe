...
use crate::fields::{ArithOpsBounds, FieldVar};
...
impl<'a, F: PrimeField> ArithOpsBounds<'a, F, Self> for FpVar<F> {}
impl<'a, F: PrimeField> ArithOpsBounds<'a, F, FpVar<F>> for &'a FpVar<F> {}
